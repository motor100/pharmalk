<section class="profile-section">
    <header>
        <div class="profile-section-title">Информация о профиле</div>
        <div class="profile-section-subtitle">Обновите информацию профиля вашей учетной записи и адрес электронной почты</div>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="form-group">
            <x-input-label for="name" :value="__('Имя')" class="label" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button class="submit-btn">{{ __('Сохранить') }}</x-primary-button>
